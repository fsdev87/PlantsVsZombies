...
public:
	BeginnersGarden(Background& background, TextureManager* TM, FontManager* FM, SoundManager* SM, Clock* RunClock, Text* TimeText, Text* sunCountText, int& sunCount, LawnMower** lawnmowers, float* lawnMowerPos) :Level(TM, FM, SM) {
		this->round = 1;
